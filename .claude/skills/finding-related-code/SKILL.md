---
name: finding-related-code
description: Find semantically related code and discover relationships between components using vector search. Use when finding similar implementations, understanding how code connects, or exploring patterns that grep would miss.
...
Vector search understands code semantically. Search for what code *does*, not what it's *named*.
