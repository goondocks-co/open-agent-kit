---
name: creating-rfcs
description: Create RFC (Request for Comments) or ADR (Architecture Decision Record) documents for formal technical planning. Use for significant architectural decisions, feature proposals, or process changes that need team review.
