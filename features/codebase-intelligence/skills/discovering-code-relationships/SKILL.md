---
name: discovering-code-relationships
...
The codebase index uses embeddings to understand code semantically. Searching for a concept returns code that's related by *meaning*, even if it uses different terminology.
...
### Get context for understanding relationships
