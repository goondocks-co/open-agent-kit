---
name: creating-rfcs
description: Create RFC (Request for Comments) or ADR (Architecture Decision Record) documents for formal technical planning. Use when proposing new features, making architectural decisions, or documenting significant technical changes that need team review.
