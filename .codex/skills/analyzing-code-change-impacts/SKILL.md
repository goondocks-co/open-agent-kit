---
name: analyzing-code-change-impacts
description: Analyze the potential impact of code changes using semantic search. Use before refactoring or modifying code to find all conceptually related code that might be affected.
