...
│   ├── rfc/              # Sub command templates, example rfc child templates
│   │   ├── engineering.md
│   │   ├── architecture.md
│   │   ├── feature.md
│   │   └── process.md
...
### 6.1 Template Type examples

1. **Command Templates** - For AI agent commands
   - `oak.rfc-create.md` - RFC creation assistant
   - `oak.rfc-validate.md` - RFC validation assistant

2. **RFC Templates** - For use by the RFC command templates
   - `engineering.md` - Full technical RFC
   - `architecture.md` - ADR format
   - `feature.md` - Feature proposals
   - `process.md` - Process improvements
...
## IX. AI Agent Integration

### 9.1 Supported Agents
...
### X-A.8 Constant Naming Conventions
...
## XIII. Documentation Standards

### 13.1 README Requirements
...
## XVI-A. Feature Delivery Playbook
...
## XVI-B. Migration System for Upgrade Tasks
