...
**Reference:** `features/rules-management/templates/decision_points.yaml` section `research_triggers` contains comprehensive patterns for detecting when research is valuable (architecture, frameworks, language versions, compliance).
