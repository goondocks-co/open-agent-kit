/**
 * Team Configuration page — server connection and sync settings.
 *
 * Provides forms for joining/leaving a team server, configuring
 * sync intervals, and toggling auto-sync.
 */
...
export default function TeamConfig() {
    ...
    const handleJoin = async () => {
        if (!joinUrl.trim() || !joinToken.trim()) {
            setJoinError("Both server URL and token are required.");
            return;
        }
        setJoinError(null);
        try {
                ...
                <CardHeader>
                    ...
                    <CardDescription>
                        {connected
                            ...
                            : "Enter your team server URL and token to connect."}
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    {connected ? (
                        <>
                            ...
                            {config?.server_mode && (
                                <div className="flex items-center gap-2 p-3 rounded-md bg-blue-500/10 text-blue-600 text-sm">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            placeholder="Your team authentication token"
