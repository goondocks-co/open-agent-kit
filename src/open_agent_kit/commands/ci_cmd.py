...
def ci_backup(
    ...
    output: str | None = typer.Option(
        ...
        "--output",
        "-o",
        help="Output path (default: oak/data/ci_history_{machine}.sql)",
    ),
) -> None:
    ...
    Each machine creates its own backup file (ci_history_{hostname}_{user}.sql)
    to prevent git conflicts when multiple developers commit backups.
